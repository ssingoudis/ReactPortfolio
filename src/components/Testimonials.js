  ...
  return (
    <section id='testimonials'>
      <div className="container px-5 py-10 mx-auto text-center">
        <svg className="w-10 inline-block mb-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
          ...
          {testimonials.map((testimonial) => (
            <div className="p-4 md:w-1/2 w-full">
              <div className="h-full bg-gray-800 bg-opacity-40 p-8 rounded">
                <svg className="block w-8 text-gray-500 mb-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                ...
                <p className="leading-relaxed mb-6">{testimonial.quote}
                  </p>
